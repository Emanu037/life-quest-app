...
class _IntroPageState extends State<IntroPage> {
  final TextEditingController _nomeGatinhoController =
  ...
  @override
  void dispose() {
    _nomeGatinhoController.dispose();
    super.dispose();
  }
  ...
  Future<void> _finalizarIntro() async {
    ...
    if (nome.isNotEmpty) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => HomePage(nomeDoGato: nome),
        ),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Dê um nome para o seu gatinho! 🐾"),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Como seu gatinho vai se chamar?",
                      style: TextStyle(
                        fontSize: 16,
